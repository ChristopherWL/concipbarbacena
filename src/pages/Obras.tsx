    ...
    <DashboardLayout>
      <div className="space-y-6" data-tour="obras-content">
        ...
        <Dialog
          ...
          modal={false}
        >
          <DialogContent className={isMobile ? "w-screen h-screen max-w-none max-h-none p-0 m-0 rounded-none gap-0 bg-background shadow-none border-0 inset-0 translate-x-0 translate-y-0 [&>button]:hidden" : "w-full max-w-3xl max-h-[90vh] p-0 bg-transparent shadow-none border-0 overflow-hidden [&>button]:hidden"}>
