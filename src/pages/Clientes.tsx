                        ...
                        <TableRow key={customer.id}>
                          <TableCell className="py-2">
                            <div>
                              ...
                              <p className="text-xs text-muted-foreground lg:hidden">{customer.document || '-'}</p>
                            </div>
                          </TableCell>
                          ...
                          <TableCell className="hidden lg:table-cell text-sm">{customer.document || '-'}</TableCell>
        ...
        <AlertDialog open={!!customerToDelete} onOpenChange={(open) => !open && setCustomerToDelete(null)}>
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                O cliente "{customerToDelete?.name}" será removido do sistema.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
